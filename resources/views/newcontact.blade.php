...
<body class="bg-gradient-primary">
          ...
          <div class="col-lg-7">
            <div class="p-5">
              <div class="text-center">
                <h1 class="h4 text-gray-900 mb-4">ENREGISTRER UN NOUVEAU CONTACT</h1>
              </div>
              <form action="{{route('contact.create')}}" method="POST">
                ...
                <div class="form-group row">
                 ...
                 <div class="form-group row">
                  ...
                  <div class="col-sm-6">
                    <input type="text" class="form-control form-control-user" id="fonction" name="fonction" placeholder="Fonction">
                  </div>
  ...
  <script src="/assets/admin/essai/vendor/jquery/jquery.min.js"></script>
  <script src="vendor/bootstrap/js/bootstrap.bundle.min.js"></script>

  <!-- Core plugin JavaScript-->
  <script src="/assets/admin/essai/vendor/jquery-easing/jquery.easing.min.js"></script>

  <!-- Custom scripts for all pages-->
  <script src="/assets/admin/essai/js/sb-admin-2.min.js"></script>
